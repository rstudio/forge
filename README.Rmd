...
---
[![Coverage status](https://codecov.io/gh/rstudio/forge/branch/master/graph/badge.svg)](https://codecov.io/github/rstudio/forge?branch=master)
...
Please note that the 'forge' project is released with a [Contributor Code of Conduct](https://github.com/rstudio/forge/blob/master/.github/CODE_OF_CONDUCT.md). By contributing to this project, you agree to abide by its terms.
