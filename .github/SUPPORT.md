# Getting help with camp

Thanks for using camp. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/camp/issues) to make sure the 
